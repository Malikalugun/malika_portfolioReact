                  ...
                  <div>
                    <div className="head-name">
                      <div className="name-icon">
                        <h3>Hey Malika</h3>
                        <img
                          src="https://cdn-icons-png.flaticon.com/128/16446/16446412.png"
                          alt="hey icon"
                        />
                      </div>
                    </div>
                    ...
                    <p className="portpara">
                      Passionate web developer from Ranchi, building fast,
                      responsive websites with clean code and modern design.
                    </p>
                    <div className="contactlink mb-4">
                      <Link to="#" className="helloBtn">
                        Say Hello <i class="fa-brands fa-telegram"></i>
                      </Link>
                      <Link to="#" className="workBtn">
                        My Work <i class="fa fa-arrow-right"></i>
                      </Link>
                    </div>
