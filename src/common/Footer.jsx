            ...
            <Row className="tfootmenu">
              ...
              <Col xl={6} lg={6} md={6} sm={12} xs={12}>
                <div className="footer-cont">
                  ...
                  <p>
                    To build clean, responsive, and user-friendly websites using
                    React, JavaScript, Laravel, and modern tools like Tailwind
                    CSS and APIs.
                  </p>
                </div>
              </Col>
            ...
            <Row>
              <Col xl={3} lg={4} md={6} sm={12} xs={12}>
                <div className="footercontact">
                  <p>Call:</p>
                  <h2>
                    <Link to="tel:7735979503">+91-7735979503</Link>
                  </h2>
                </div>
              </Col>
